...
3. If using default paths, this should just work: `unzip ~/Downloads/PlayBTW_v1_35_base_with_ai.zip -d ~/.config/espanso/`
...
| Challenge skill test         | `:gchskill`                                |
| Challenge situation          | `:gchsit`                                  |
| Challenge prompt             | `:gchpro`                                  |
| Challenge condition          | `:gchcond`                                 |
